...
namespace wjs_c08_react_api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
                ...
                options.AddPolicy(name: "Hubs",
                    builder =>
                    {
                        builder
                            .AllowAnyMethod()
                            .AllowAnyHeader()
                            .WithOrigins("http://localhost:3000", "https://wsuetholz.github.io")
                            .AllowCredentials();
                    });
            });
            ...
            services.AddSwaggerGen(c =>
            {
                c.SwaggerDoc("v1", new OpenApiInfo { 
                    Title = "Olympic Medals App (WJS)", 
                    Version = "v1",
                    Description = "Track Olympic Medals By Country"
                });
                c.EnableAnnotations();
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "wjs_c08_react_api v1");
                c.RoutePrefix = "";
            });
